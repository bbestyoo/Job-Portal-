                  ...
                  <div className=" w-1/2 ">
                    ...
                    <div className="mt-1 ">
                      <input
                        ...
                        value={jobData.title}
                        type="text"
                        className=" mb-3 pl-2 block w-full rounded-md border-0 py-1.5 focus:outline-none text-gray-900 shadow-sm ring-1 ring-inset ring-gray-400  placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-orange-600 sm:text-sm sm:leading-6"
                      />
                    </div>
