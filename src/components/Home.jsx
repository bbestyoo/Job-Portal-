  ...
  return (
    <div className="mt-20 ">
      ...
      <div>
        ...
        <div className="">
          <div className="flex justify-between p-5 bg-footer">
            <div className=" p-1 py-5 rounded-lg text-left text-xs w-1/3 ">
              <p>Since its inception in 2023, this site has been at the forefront of connecting job seekers and employers in Nepal and around the globe. The goal is to provide a comprehensive platform for job seekers to find jobs in Nepal and for employers to find the right fit for their organization. We pride ourselves on being a reliable bridge between hiring employers and job seekers and have established ourselves as a national leader in recruitment solutions. <Link className="text-primary">Read more...</Link></p>
            </div>
