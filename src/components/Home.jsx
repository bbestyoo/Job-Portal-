...
export default function Home() {
  return (
    <div className="mt-20">
      ...
      <p className=" text-xl mb-20">10000 Jobs registered and 10000 employed</p>
      ...
      <div className=" border-2 h-16 p-1 inline-block ps-5  text-l rounded-3xl">
        <div className="flex gap-3 h-full max-w-full items-center">
          ...
          <input placeholder="Search yr Job here"/>
          <div className="h-5/6 mx-4 my-1 border border-gray-400"></div>
          <input placeholder="Enter yr location here" className="mr-3"/>
      ...
      <div className="bg-secondary mt-20 p-5">
      ...
      {/* <..............footer...........> */}
      <div>
        <div className="flex border border-gray-400 w-fit p-5 text-5xl gap-10 mb-16">
