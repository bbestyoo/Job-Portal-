  ...
  return (
    <>
      <div
        ...
        } p-1  ps-5 bg-gray-200  text-l rounded-3xl  transition-all duration-300 shadow-3xl hidden md:inline-block  `}
      >
        <div
          className={` ${
        ...
        >
          ...
          <input
            ...
            onBlur={handleOnBlur}
            className="outline-none bg-gray-200 text-black placeholder:text-black"
            placeholder="Search yr Job here"
          />
          <div className="h-5/6 mx-4 my-1 border border-gray-300"></div>
          <input
            placeholder="Enter yr location here"
            className="mr-3 outline-none bg-gray-200 text-black placeholder:text-black "
          />
